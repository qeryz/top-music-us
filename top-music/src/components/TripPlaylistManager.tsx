    ...
    <div className="flex-1 px-4 md:px-8 py-6 md:py-12 max-w-7xl mx-auto w-full flex flex-col gap-8">
        ...
        <div className="flex items-center gap-8 border-b border-white/10 pb-4">
          <button 
              ...
              className={`text-xl font-bold transition-colors cursor-pointer ${activeTab === 'my-playlists' ? 'text-white border-b-2 border-white' : 'text-white/40 hover:text-white/70'}`}
          >
              My Playlists
          </button>
          <button 
              onClick={() => setActiveTab('create-new')}
              className={`text-xl font-bold transition-colors cursor-pointer ${activeTab === 'create-new' ? 'text-white border-b-2 border-white' : 'text-white/40 hover:text-white/70'}`}
          >
              Create New
          </button>
        </div>
