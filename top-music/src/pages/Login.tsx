      ...
      <main className="flex-grow flex items-center justify-center px-8 pb-20">
        <div className="w-full max-w-[880px] rounded-3xl overflow-hidden shadow-2xl">
            ...
            >
                ...
                {/* Card Content */}
                <div className="select-none relative flex flex-col items-center justify-center text-center px-8 py-16 min-h-[420px]">
                    <div className="space-y-4 max-w-2xl">
                        <h1 className="text-5xl md:text-6xl font-black tracking-tight text-white">
                            Your Ultimate Road Trip Soundtrack
                        </h1>
                        <p className="select-none text-base text-white/70 font-normal">
                    ...
                    <div className="mt-8">
                        <button 
                            onClick={handleLogin}
                            className="cursor-pointer inline-flex items-center gap-2 bg-primary hover:bg-[#1ed760] text-black font-bold py-3 px-6 rounded-full transition-all duration-200 transform hover:scale-105"
                        >
